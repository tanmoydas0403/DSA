package com.tanmoy.theory.segmentTree;
...
public class SegmentTree {
    ...
    public static void main(String[] args) {
        ...
        tree.update(3, 10); // Update index 3 from 7 to 10
        System.out.println("After update at index 3:");
        // tree.display();
        System.out.println("Query [1, 6]: " + tree.query(1, 6)); 
    ...
    private void update(Node node, int index, int value) {
        ...
        // Update current node's data after child update
        node.data = node.left.data + node.right.data;
    }
